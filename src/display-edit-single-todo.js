...
export function displayTodoContent() {
  ...
  content.addEventListener("click", (e) => {
    ...
    const todoIndex = myToDos.findIndex(
      (obj) => obj.id === card.getAttribute("todo-id"),
    );
    ...
    thisTodoEdit.addEventListener("click", () => {
      ...
      editDialog.querySelector("#cancel-edit-btn").addEventListener(
        "click",
        (e) => {
          e.preventDefault();
          editDialog.close();
      ...
      editDialog.querySelector("#submit-edit-btn").addEventListener(
        "click",
        (e) => {
          e.preventDefault();
